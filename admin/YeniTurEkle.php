...
<section class="content">
	<div class="box">
		...
		<p><label>Tur Adı </label><input type="text" name="adi" class="form form-control" style="width:30%;"></p>
		...
		<div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="gidisTarih" style="width:15%;" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                    </div><!-- /.input group -->
        </div>
		<div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="donusTarih" style="width:15%;" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                    </div><!-- /.input group -->
        </div>
		<p><label>Süre (otomatik hesaplama için boş bırak)</label><br>
		<input type="text" name="sure" style="width:15%;" class="form-control"></p>
		<p><label>Ücret (Örnek: 599)</label><br><input type="text" name="ucret" style="width:15%;" class="form-control"></p>
		<p><label>Para birimi (örn: €)</label><br> <input type="text" name="parabirim" style="width:5%;" class="form-control"></p>
		<p><label>Pansiyon Tipi</label><br> <input type="text" name="pansiyontipi"></p>
		...
		<p><label>Kapasite (Örnek: 40)</label><br> <input type="text" name="kapasite" style="width:5%;" class="form-control"></p>
		...
		<p><label>Ülke Şehir Bilgisi (örnk: 6 Ülke, 9 Şehir)</label><br> <input type="text" name="ulkeSehir" style="width:30%;" class="form-control"></p>
